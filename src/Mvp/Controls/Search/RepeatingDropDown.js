...
{
    window.gcd.core.mvp.viewBridgeClasses.DropDownViewBridge.apply( this, arguments );
...
repeatingDropDown.prototype = new window.gcd.core.mvp.viewBridgeClasses.DropDownViewBridge();
...
{
    window.gcd.core.mvp.viewBridgeClasses.DropDownViewBridge.prototype.setCurrentlyAvailableSelectionItems.apply( this, [ items ] );
...
repeatingDropDown.prototype.updateDom = function()
{
    ...
    this.container.find( 'select').unbind( 'change').change( function(){ self.updateDom() } );
}
...
window.gcd.core.mvp.viewBridgeClasses.RepeatingDropDown = repeatingDropDown;
	...
	$( ".row-controls .edit", this.element).click( function()
	{
		...
		$( "td", tr ).each( function()
		{
			...
			if ( self.model.SpawnSettings[ index ] )
			{
                ...
                // Spawn the interface
				var control = window.gcd.core.mvp.spawn( self.model.SpawnSettings[ index ], tr.data( "row-id" ) );
...
window.gcd.core.mvp.viewBridgeClasses.TableWithEditableCellsViewBridge = bridge;
